...
Copyright (c) 2015 Satoshi MIMURA.
...
namespace UsagiProject
{
    /// <summary>
    /// This class extends the ProjectNode in order to represent our project 
    /// within the hierarchy.
    /// </summary>
    [Guid("D4854F6D-CAA1-4D6C-AB09-B7AED6DA11F9")]
    public class UsagiProjectNode : ProjectNode
    {
        #region Enum for image list
        internal enum UsagiProjectImageName
        {
            Project = 0,
        }
        #endregion
        ...
        #region Constants
        internal const string ProjectTypeName = "UsagiProject";
        #endregion
        ...
        #region Constructors
        /// <summary>
        /// Initializes the <see cref="UsagiProjectNode"/> class.
        /// </summary>
        static UsagiProjectNode()
        {
            imageList = Utilities.GetImageList(typeof(UsagiProjectNode).Assembly.GetManifestResourceStream("UsagiProject.Resources.MyCustomProjectImageList.bmp"));
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="UsagiProjectNode"/> class.
        /// </summary>
        /// <param name="package">Value of the project package for initialize internal package field.</param>
        public UsagiProjectNode(CustomProjectPackage package)
        {
        ...
        {
            get { return typeof(UsagiProjectFactory).GUID; }
        }
        ...
        public override int ImageIndex
        {
            get
            {
                return imageOffset + (int)UsagiProjectImageName.Project;
            }
        }
        ...
        {
            return new OAUsagiProject(this);
        }
        ...
        {
            UsagiProjectFileNode node = new UsagiProjectFileNode(this, item);
