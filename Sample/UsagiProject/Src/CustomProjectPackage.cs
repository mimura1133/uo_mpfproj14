...
namespace UsagiProject
{
    ...
    [ProvideProjectFactory(typeof(UsagiProjectFactory), "Usagi Project", "Usagi Project Files (*.usaproj);*.usaproj", "usaproj", "usaproj", @"..\..\Templates\Projects\UsagiProject", LanguageVsTemplate = "UsagiProject", NewProjectRequireNewFolderVsTemplate = false)]
    [ProvideProjectItem(typeof(UsagiProjectFactory), "Usagi Items", @"..\..\Templates\ProjectItems\UsagiProject", 500)]
    ...
    public sealed class CustomProjectPackage : ProjectPackage
    {
        ...
        {
            base.Initialize();
            this.RegisterProjectFactory(new UsagiProjectFactory(this));
        }
